...
?>
		...
		<div id="sidebar">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><a href="/help"><img src="/skin/<? echo $public_skin ?>/img/menu_main_1.jpg" title="도움말" /></a></td>
				</tr>
                <? if (!$_SESSION['user']) { ?>
				<tr>
					<td><? echo ($_SERVER["SCRIPT_NAME"] == "/process/short.php") ? "<a href=\"/?mode=create\">" : "<a href=\"#\" id=\"create-user-a\">" ?><img src="/skin/<? echo $public_skin ?>/img/menu_main_2_0.jpg" title="회원가입" /></a></td>
				</tr>
				<tr>
					<td><? echo ($_SERVER["SCRIPT_NAME"] == "/process/short.php") ? "<a href=\"/\">" : "<a href=\"#\" id=\"login-user-a\">" ?><img src="/skin/<? echo $public_skin ?>/img/menu_main_3_0.jpg" title="로그인" /></a></td>
				</tr>
				<tr>
					<td><img src="/skin/<? echo $public_skin ?>/img/menu_main_4_1.jpg" /></td>
				</tr>
                <? }else{ ?>
                <tr>
					<td><?
                    ...
                    ?><a href="#" id="mypage<? echo $mypage ?>-a"><img src="/skin/<? echo $public_skin ?>/img/menu_main_2_1.jpg" title="마이페이지" /></a></td>
				</tr>
				<tr>
					<td><a href="#" id="set-a"><img src="/skin/<? echo $public_skin ?>/img/menu_main_3_1.jpg" title="설정" /></a></td>
				</tr>
                	<? if ($_SESSION['set_user_url'] == ""){ ?>
                    <tr>
                        <td><a href="#" id="logout-a"><img src="/skin/<? echo $public_skin ?>/img/menu_main_5_0.jpg" title="로그아웃" /></a></td>
                    </tr>
                    <tr>
                        <td><img src="/skin/<? echo $public_skin ?>/img/menu_main_6_1.jpg" /></td>
                    </tr>
                    <? }else{ ?>
                    <tr>
                        <td><a href="<? echo "/".$_SESSION['set_user_url']; ?>"><img src="/skin/<? echo $public_skin ?>/img/menu_main_4_0.jpg" title="공개주소" /></a></td>
                    </tr>
                    <tr>
                        <td><a href="#" id="logout-a"><img src="/skin/<? echo $public_skin ?>/img/menu_main_5_1.jpg" title="로그아웃" /></a></td>
                    </tr>
                    <? } ?>
                <? } ?>
			</table>
			<? if (isset($_SESSION['user'])){ ?>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <a href="#" id="toolbar_memo_recv"><img src="/skin/<? echo $public_skin ?>/img/memo.gif" title="<? echo get_message($_SESSION['user']) ?>" /></a><br />
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="footer">
		<tr>
			<td><p>Internet Explorer 7.0 or higher / Copyright&copy; 2012<? echo (date("Y") != 2012) ? "-".date("Y") : "" ?> <? echo $common_title_tail ?>. All Rights Reserved.</strong>&nbsp;|&nbsp;<a href="/developers" title="open API">API</a>&nbsp;|&nbsp;<a href="/feedback" title="피드백">Feedback</a>&nbsp;|&nbsp;<a href="/donate" title="후원">Donate</a></p></td>
		</tr>
	</table>
</div>
...
<div id="left">
	<table class="fbConnect" align="center" border="0" cellspacing="0" cellpadding="0">
  		<tr>
    		<td><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_register_01.gif" border="0" /><br /><a href="/redirect.php"><img src="/skin/<? echo $common_skin ?>/img/fb_tw_gg_register_02.gif" border="0" /></a>&nbsp;<a href="<? echo $fb_loginUrl ?>"><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_register_03.gif" border="0" /></a>&nbsp;<a href="<? echo $authUrl ?>"><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_register_04.gif" border="0" /></a></td>
    		<td width="65" align="right"><img src="/skin/<? echo $public_skin ?>/img/fb_tw_login_03.gif" border="0" /></td>
  		</tr>            
	</table>
</div>
<div id="right">
...
<div id="left">
	<table class="fbConnect" align="center" border="0" cellspacing="0" cellpadding="0">
    	<td><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_login_01.gif" border="0" /><br /><a href="/redirect.php"><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_login_02.gif" border="0" /></a>&nbsp;<a href="<? echo $fb_loginUrl ?>"><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_login_03.gif" border="0" /></a>&nbsp;<a href="<? echo $authUrl ?>"><img src="/skin/<? echo $public_skin ?>/img/fb_tw_gg_login_04.gif" border="0" /></a></td>
...
jQuery(function($){
    ...
    $('#fr_date, #to_date').datepicker({
        showOn: 'button',
		buttonImage: '/skin/<? echo $public_skin ?>/img/calendar.gif',
...
<div id="hidden-message-dropout" style="display:none">
	<p><span class="ui-icon ui-icon-circle-check" style="float:left; margin:0 7px 45px 0;"></span>계정을 삭제하시겠습니까?<br />
