...
<link rel="stylesheet" href="/skin/<? echo $common_skin ?>/point/css/default.css">
...
<!--<font size="+6">임시 (since 121120)</font>-->

<? //echo "<strong>".$_SESSION['user']."</strong><br>"; ?>

<div style="padding-bottom:15px"><img src="/skin/<? echo $common_skin ?>/img/history_list.gif" /></div>
